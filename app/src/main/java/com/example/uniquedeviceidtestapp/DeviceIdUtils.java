...
/**
 * Created by Steffen Funke on 05.09.16.
 */
...
public class DeviceIdUtils {
    ...
    public static void init(Context context) {
        mDeviceId = getUniquePsuedoID();

        /*
        // needs "dangerous" permission READ_PHONE_STATE (requires user action in Android >= 6)
    ...
    public static String getDeviceUid() {
        if(mDeviceId == null) {
            throw new NullPointerException("mDeviceId may not be null, DeviceIdUtils initialized in Application?");
        }
        return mDeviceId;
    }
